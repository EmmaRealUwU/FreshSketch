...
//int[] delays = [1000, 10000, 60000, 600000];
int currentDelay = 0;
int delayShown = -1; // -1 - current delay, 0 - 1000ms, 1 - 10000ms, 2 - 60000ms, 3 - 600000
...
void readButtons(){if(millis() - lastRead >= buttonDelay){
